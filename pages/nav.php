<div id="nav">
	<ul>
		...
		<?php
			...
			$rez = mysqli_query($konekcija, $upit) or die("Greska prilikom iscitavanja
			navigacije!");
			...
			if(isset($_SESSION['idU']) && $_SESSION['uloga'] == 'admin')
				{
					...
					$rezultat = mysqli_query($konekcija , $upit_g) or die("Greska prilikom
					iscitavanja admin panela!");
					while($rezu=mysqli_fetch_array($rezultat))
						{
					echo "<li><a href='index.php?category=pages&page=page{$rezu['adID']}'>{$rezu['navName']}</a></li>";
						};
				}
