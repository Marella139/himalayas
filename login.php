...
if(isset($_REQUEST['btnLogin']))
	{
		...
		$upit = "SELECT * FROM users u JOIN user_function uf ON u.id_user=uf.id_user JOIN function f ON f.id_function=uf.id_function WHERE user_name='$korIme' AND password = '$lozinka'";
